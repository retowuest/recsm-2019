...
The test set MSE is 8.67. This indicates that random forests yielded an improvement over bagging in this case. Using the `importance()` and `varImpPlot()` functions, we can view the importance of each variable.
